module.exports = function (m) {
    ...
    m.issue_actions.hasOne(         m.locations,           {foreignKey: 'location_id',           sourceKey: 'location_id',           constraints: false});
    m.issue_actions.belongsTo(      m.loancard_lines,      {foreignKey: 'loancard_line_id',      targetKey: 'line_id',               constraints: false});
    ...
    m.loancard_lines.hasMany(       m.issue_actions,       {foreignKey: 'loancard_line_id',      sourceKey: 'line_id'});
    ...
    m.nsns.hasOne(                  m.nsn_classifications, {foreignKey: 'nsn_classification_id', sourceKey: 'nsn_classification_id', constraints: false, as: 'classification'});
