module.exports = function (m) {
    ...
    m.categories.hasMany(      m.categories,     {foreignKey: 'parent_category_id', sourceKey: 'category_id',                        as: 'children'});
    m.categories.belongsTo(    m.categories,     {foreignKey: 'parent_category_id', targetKey: 'category_id',                        as: 'parent'});
    ...
    m.demand_lines.hasMany(    m.actions,        {foreignKey: 'demand_line_id',     sourceKey: 'line_id'});
    ...
    m.nsn_groups.hasMany(      m.nsn_classes,    {foreignKey: 'nsn_group_id',       targetKey: 'nsn_group_id',                       as: 'classes'});
    m.nsn_classes.belongsTo(   m.nsn_groups,     {foreignKey: 'nsn_group_id',       targetKey: 'nsn_group_id',                       as: 'group'});
    m.nsn_classes.belongsTo(   m.nsns,           {foreignKey: 'nsn_class_id',       targetKey: 'nsn_class_id',                       as: 'class'});
    ...
    m.nsns.hasOne(             m.nsn_groups,     {foreignKey: 'nsn_group_id',       sourceKey: 'nsn_group_id',   constraints: false, as: 'group'});
    m.nsns.hasOne(             m.nsn_classes,    {foreignKey: 'nsn_class_id',       sourceKey: 'nsn_class_id',   constraints: false, as: 'class'});
    m.nsns.hasOne(             m.nsn_countries,  {foreignKey: 'nsn_country_id',     sourceKey: 'nsn_country_id', constraints: false, as: 'country'});
    ...
    m.stocks.hasMany(          m.actions,        {foreignKey: 'stock_id',           targetKey: 'stock_id'});
