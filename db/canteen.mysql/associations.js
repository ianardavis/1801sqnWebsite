module.exports = function (m) {  
    ...
    m.items.hasMany(      m.receipts,    {foreignKey: 'item_id',    targetKey: 'item_id'});
    m.items.hasMany(      m.writeoffs,   {foreignKey: 'item_id',    targetKey: 'item_id'});
    ...
    m.receipts.belongsTo( m.items,       {foreignKey: 'item_id',    targetKey: 'item_id'});
    m.writeoffs.belongsTo(m.items,       {foreignKey: 'item_id',    sourceKey: 'item_id'});
