module.exports = function (m) {  
    ...
    m.accounts.hasOne(      m.users, {foreignKey: 'user_id', sourceKey: 'user_id_account',  constraints: false, as: 'user_account'});
    m.accounts.hasOne(      m.users, {foreignKey: 'user_id', sourceKey: 'user_id',          constraints: false, as: 'user'});
