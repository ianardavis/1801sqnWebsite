...
db.item_sizes.hasMany(db.nsns,       {foreignKey: 'stock_id',    targetKey: 'stock_id'});
db.item_sizes.hasMany(db.locations,  {foreignKey: 'stock_id',    targetKey: 'stock_id'});
db.item_sizes.belongsTo(db.items,    {foreignKey: 'item_id',     targetKey: 'item_id'});
db.item_sizes.hasMany(db.requests_l, {foreignKey: 'stock_id',    sourceKey: 'stock_id'});
db.item_sizes.hasMany(db.orders_l,   {foreignKey: 'stock_id',    sourceKey: 'stock_id'});
db.item_sizes.hasMany(db.demands_l,  {foreignKey: 'stock_id',    sourceKey: 'stock_id'});
db.item_sizes.hasMany(db.receipts_l, {foreignKey: 'stock_id',    sourceKey: 'stock_id'});
db.item_sizes.hasMany(db.issues_l,   {foreignKey: 'stock_id',    sourceKey: 'stock_id'});

db.suppliers.hasMany(db.item_sizes,   {foreignKey: 'supplier_id', sourceKey: 'supplier_id', as: 'sizes'});
db.locations.belongsTo(db.item_sizes, {foreignKey: 'stock_id', targetKey: 'stock_id', as: 'size'});
db.nsns.belongsTo(db.item_sizes,      {foreignKey: 'stock_id', targetKey: 'stock_id', as: 'size'});
...
db.issues_l.hasOne(db.users,      {foreignKey: 'user_id',     sourceKey: 'returned_to',     constraints: false, as: 'returnedTo'});
db.issues_l.hasOne(db.item_sizes, {foreignKey: 'stock_id',    sourceKey: 'stock_id',        constraints: false, as: 'size'});
db.issues_l.hasOne(db.nsns,       {foreignKey: 'nsn_id',      sourceKey: 'nsn_id',          constraints: false});
db.issues_l.hasOne(db.locations,  {foreignKey: 'location_id', sourceKey: 'issue_location',  constraints: false, as: 'issueLocation'});
db.issues_l.hasOne(db.locations,  {foreignKey: 'location_id', sourceKey: 'return_location', constraints: false, as: 'returnLocation'});
...
db.requests_l.hasOne(db.users,       {foreignKey: 'user_id',    sourceKey: 'approved_by', constraints: false, as: 'approvedBy'});
db.requests_l.hasOne(db.item_sizes,  {foreignKey: 'stock_id',   sourceKey: 'stock_id',    constraints: false, as: 'size'});
...
db.receipts.hasOne(db.users,       {foreignKey: 'user_id',     sourceKey: 'user_id',     constraints: false, as: 'receivedBy'});
...
db.receipts_l.hasOne(db.item_sizes,  {foreignKey: 'stock_id',   sourceKey: 'stock_id', constraints: false, as: 'size'});
...
db.demands.hasOne(db.users,      {foreignKey: 'user_id',     sourceKey: 'user_id',     as: 'user', constraints: false});
db.demands.hasMany(db.demands_l, {foreignKey: 'demand_id',   targetKey: 'demand_id',   as: 'lines'});

db.demands_l.hasOne(db.item_sizes, {foreignKey: 'stock_id',  sourceKey: 'stock_id',        constraints: false, as: 'sizes'});
