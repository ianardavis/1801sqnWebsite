...
db.issues.hasOne(db.items_locations,         {foreignKey: 'location_id', sourceKey: '_issue_location',  constraints: false, as: 'issueLocation'});
db.issues.hasOne(db.items_locations,         {foreignKey: 'location_id', sourceKey: '_return_location', constraints: false, as: 'returnLocation'});
