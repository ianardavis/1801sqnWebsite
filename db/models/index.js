...
db.issues.hasOne(db.users,           {foreignKey: 'user_id',       sourceKey: 'issued_to',       constraints: false, as: '_for'});
...
db.returns.hasOne(db.users,          {foreignKey: 'user_id',       sourceKey: 'user_id',         constraints: false, as: '_to'});
