...
db.orders.hasOne(db.item_sizes, {foreignKey: 'stock_id',    sourceKey: 'stock_id',    constraints: false, as: 'sizes'});
...
db.orders.hasOne(db.suppliers,  {foreignKey: 'supplier_id', sourceKey: 'supplier_id', constraints: false});
