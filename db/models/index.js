...
db.item_sizes.hasMany(db.nsns,          {foreignKey: 'item_size_id', targetKey: 'item_size_id'});
db.item_sizes.belongsTo(db.items,       {foreignKey: 'item_id',      targetKey: 'item_id'});
db.item_sizes.hasMany(db.request_lines, {foreignKey: 'item_size_id', targetKey: 'item_size_id', as: 'requests'});
db.item_sizes.hasMany(db.order_lines,   {foreignKey: 'item_size_id', targetKey: 'item_size_id', as: 'orders'});
db.item_sizes.hasMany(db.demand_lines,  {foreignKey: 'item_size_id', targetKey: 'item_size_id', as: 'demands'});
db.item_sizes.hasMany(db.issue_lines,   {foreignKey: 'item_size_id', targetKey: 'item_size_id', as: 'issues'});
db.item_sizes.hasMany(db.stock,         {foreignKey: 'item_size_id', targetKey: 'item_size_id'});
db.item_sizes.hasMany(db.serials,       {foreignKey: 'item_size_id', targetKey: 'item_size_id'});
db.nsns.belongsTo(db.item_sizes,        {foreignKey: 'item_size_id', targetKey: 'item_size_id'});
db.stock.belongsTo(db.item_sizes,       {foreignKey: 'item_size_id', targetKey: 'item_size_id'});
...
db.stock.hasMany(db.issue_lines,   {foreignKey: 'stock_id',    targetKey: 'stock_id'});
db.stock.hasMany(db.receipt_lines, {foreignKey: 'stock_id',    targetKey: 'stock_id'});
db.stock.hasMany(db.return_lines,  {foreignKey: 'stock_id',    targetKey: 'stock_id'});
db.adjusts.hasOne(db.users,        {foreignKey: 'user_id',     sourceKey: 'user_id',     constraints: false});

db.suppliers.hasMany(db.item_sizes, {foreignKey: 'supplier_id',  targetKey: 'supplier_id'});
...
db.issue_lines.hasOne(db.item_sizes,   {foreignKey: 'item_size_id', sourceKey: 'item_size_id',   constraints: false});
...
db.issue_lines.hasOne(db.return_lines, {foreignKey: 'line_id',      sourceKey: 'return_line_id', constraints: false});
...
db.order_lines.hasOne(db.item_sizes,    {foreignKey: 'item_size_id', sourceKey: 'item_size_id',    constraints: false});
...
db.request_lines.hasOne(db.item_sizes,  {foreignKey: 'item_size_id', sourceKey: 'item_size_id', constraints: false});
...
db.demand_lines.hasOne(db.item_sizes, {foreignKey: 'item_size_id', sourceKey: 'item_size_id', constraints: false});
...
db.serials.belongsTo(db.item_sizes, {foreignKey: 'item_size_id', targetKey: 'item_size_id'});
db.serials.hasOne(db.issue_lines,   {foreignKey: 'line_id',      sourceKey: 'issue_line_id', constraints: false});
