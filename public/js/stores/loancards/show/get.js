...
function getLoancard() {
    get(
        ...
        function (loancard, options) {
            ...
            set_attribute({id: 'user_loancard_link', attribute: 'href', value: `/users/${loancard.user_id_loancard}`});
            set_attribute({id: 'user_link',          attribute: 'href', value: `/users/${loancard.user_id}`});
