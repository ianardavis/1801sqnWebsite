...
function showLine(event) {
    get(
        ...
        function (line, options) {
            ...
            set_attribute({id: 'line_item_view_link', attribute: 'href', value: `/items/${line.size.item_id}`});
            set_innerText({id: 'line_size_view',      text: line.size._size});
            set_attribute({id: 'line_size_view_link', attribute: 'href', value: `/sizes/${line.size_id}`});
            set_innerText({id: 'line_qty_view',       text: line._qty});
            set_innerText({id: 'line_user_view',      text: print_user(line.user)});
            set_attribute({id: 'line_user_view_link', attribute: 'href', value: `/users/${line.user_id}`});
