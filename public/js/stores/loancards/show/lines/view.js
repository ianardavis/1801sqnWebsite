                ...
                try {
                    ...
                    if (line.status === 1 || line.status === 2) {
                        if (typeof nil_radio === 'function') {
                            radios.appendChild(nil_radio(line.line_id, row_index));
                            ...
                            if (line.status === 1) {
                                if (
                                    ...
                                    radios.appendChild(cancel_radio(line.line_id, row_index, cancel_options));
                                };
                            };
                            ...
                            if (line.status === 2) {
                                if (
                                    ...
                                    radios.appendChild(return_radio(line.line_id, row_index, return_options));
                                };
                            };
                        };
                    };
                    add_cell(row, {append: [radios, div_details(line.line_id, row_index)]});
                    add_cell(row, {append: 
                        new Modal_Button(
                            _search(),
                            'line_view',
