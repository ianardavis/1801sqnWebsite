    ...
    get(
        {
            ...
            onFail: function () {window.location.href = '/issues'}
        },
        function (issue, options) {
            set_innerText({id: `user_issue`,      text: print_user(issue.user_issue)});
            set_attribute({id: `user_issue_link`, attribute: 'href', value: `/users/${issue.user_id_issue}`});
            set_innerText({id: 'size_desc',       text: issue.size._size});
            set_attribute({id: 'size_desc_link',  attribute: 'href', value: `/sizes/${issue.size_id}`});
            set_innerText({id: 'item_name',       text: issue.size.item._description});
            set_attribute({id: 'item_name_link',  attribute: 'href', value: `/items/${issue.size.item_id}`});
