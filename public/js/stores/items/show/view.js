function getItem() {
    ...
    .then(function ([item, options]) {
        ...
        set_innerText({id: 'size_text1_sizes_table', text: item.size_text1});
        set_innerText({id: 'item_size_text2',        text: item.size_text2});
        set_innerText({id: 'size_text2_sizes_table', text: item.size_text2});
        set_innerText({id: 'item_size_text3',        text: item.size_text3});
        set_innerText({id: 'size_text3_sizes_table', text: item.size_text3});
