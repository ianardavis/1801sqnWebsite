...
function viewLoancard(line_id) {
    function display_details([line, options]) {
        ...
        setInnerText('loancard_line_serial',    (line.serial ? line.serial.serial    : ''));
        setInnerText('loancard_line_qty',       line.qty);
    ...
    function set_links(line) {
        ...
        setHREF('loancard_line_item_link',   (line.size                   ? (line.size.item ? `/items/${line.size.item_id}` : null) : null));
        ...
        setHREF('loancard_line_serial_link', (line.serial                 ? `/serials/${line.serial_id}`               : null));
...
window.addEventListener('load', function () {
    ...
    addSortListeners('loancard_lines', getLoancards);
    getLoancards();
});