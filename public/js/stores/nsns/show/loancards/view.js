...
function viewLoancard(line_id) {
    ...
    .then(function ([line, options]) {
        ...
        set_innerText('loancard_line_serial',    (line.serial ? line.serial.serial    : ''));
        set_innerText('loancard_line_qty',       line.qty);
        ...
        set_href('loancard_line_item_link',   (line.size                   ? (line.size.item ? `/items/${line.size.item_id}` : null) : null));
        ...
        set_href('loancard_line_serial_link', (line.serial                 ? `/serials/${line.serial_id}`               : null));
