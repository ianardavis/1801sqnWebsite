...
function add_modal (line) {
    ...
    ['Demand', 'Receipt', 'Issue'].forEach(e => {
        if (line[`${e.toLowerCase()}_date`])    nav_body_2.appendChild(new Input_Group({title: `${e}ed`,       text: print_date(line[`${e.toLowerCase()}_date`])}).e);
        if (line[`${e.toLowerCase()}_line_id`]) nav_body_2.appendChild(new Input_Group({title: `${e} Line ID`, text: line[`${e.toLowerCase()}_line_id`], link: `/stores/demand_lines/${line[`${e.toLowerCase()}_line_id`]}`}).e);
        if (line[`user_${e.toLowerCase()}`])    nav_body_2.appendChild(new Input_Group({title: `${e}ed By`,    text: print_user(line[`user_${e.toLowerCase()}`]), link: `/stores/users/${line[`${e.toLowerCase()}_user_id`]}`}).e);
