...
function getPaidInOut() {
    ...
    .then(function ([paid_in_out, options]) {
        ...
        setInnerText('paid_in_out_user_paid_in_out', print_user(paid_in_out.user_paid_in_out));
        ...
        setInnerText('paid_in_out_user',             print_user(paid_in_out.user));
        setInnerText('paid_in_out_createdAt',        print_date(paid_in_out.createdAt));
        setInnerText('paid_in_out_updatedAt',        print_date(paid_in_out.updatedAt));
