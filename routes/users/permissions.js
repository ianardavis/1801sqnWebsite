module.exports = (app, m, fn) => {
    ...
    //     ]},
    // ];
    app.get('/get/permissions', fn.loggedIn(), fn.permissions.check('access_users'), (req, res) => {
    ...
    app.put('/permissions/:id', fn.loggedIn(), fn.permissions.check('user_admin'), (req, res) => {
        fn.allowed(req.user.user_id, 'edit_own_permissions', true)
        .then(edit_own => {
            fn.get(
                'users',
