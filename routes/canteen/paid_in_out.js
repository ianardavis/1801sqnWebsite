module.exports = (app, m, fn) => {
    app.get('/paid_in_outs',        fn.loggedIn(), fn.permissions.get('access_paid_in_outs'),   (req, res) => res.render('canteen/paid_in_outs/index'));
    app.get('/paid_in_outs/:id',    fn.loggedIn(), fn.permissions.get('access_paid_in_outs'),   (req, res) => res.render('canteen/paid_in_outs/show'));
    ...
    app.put('/paid_in_outs/:id',    fn.loggedIn(), fn.permissions.check('paid_in_out_edit'),    (req, res) => {
    ...
    app.delete('/paid_in_outs/:id', fn.loggedIn(), fn.permissions.check('paid_in_out_delete'),  (req, res) => {
