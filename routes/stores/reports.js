module.exports = (app, m, fn) => {
    ...
    app.get('/reports/4', fn.loggedIn(), fn.permissions.get('stores_stock_admin'), (req, res) => res.render('stores/reports/show/5'));
    app.get('/reports/5', fn.loggedIn(), fn.permissions.get('stores_stock_admin'), (req, res) => res.render('stores/reports/show/6'));
