module.exports = (app, m, pm, op, inc, li, send_error) => {
    let fn = {};
    require(`${process.env.FUNCS}/nullify`)(fn);
    app.get('/items',                  li, pm.get('access_items'),   (req, res) => res.render('stores/items/index'));
    app.get('/items/:id',              li, pm.get('access_items'),   (req, res) => res.render('stores/items/show'));
    
    app.get('/get/items',              li, pm.check('access_items'), (req, res) => {
        m.items.findAll({
            where:   req.query,
            include: [inc.genders()]
        })
    ...
    app.get('/get/item',               li, pm.check('access_items'), (req, res) => {
        m.items.findOne({
            where:   req.query,
            include: [inc.genders()]
        })
    ...
    app.get('/get/item_categories',    li, pm.check('access_items'), (req, res) => {
    ...
    app.get('/get/item_category',      li, pm.check('access_items'), (req, res) => {
    ...
    app.put('/items/:id',              li, pm.check('item_edit'),    (req, res) => {
        req.body.item = nullify(req.body.item);
        m.items.update(
            req.body.item,
    ...
    app.delete('/items/:id',           li, pm.check('item_delete'),  (req, res) => {
    ...
    app.delete('/item_categories/:id', li, pm.check('item_edit'),    (req, res) => {
