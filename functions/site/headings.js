module.exports = function (m, fn) {
    fn.site.links.headings.get_all = function (query) {
    ...
    fn.site.links.headings.get = function (where) {
        return fn.get(
    ...
    fn.site.links.headings.edit = function (resource_link_heading_id, details) {
        ...
        return new Promise((resolve, reject) => {
            fn.site.links.headings.get({ resource_link_heading_id: resource_link_heading_id })
            .then(update_heading)
            .then(resolve)
            .catch(reject);
        });
